# Citate Word for Windows Integration

This is a Citate extension that consists of a library written in C++ that communicates with Microsoft Word out of process using OLE Automation, a js-ctypes wrapper for said library, and a template that is installed into Microsoft Word to communicate with Citate.
...
This sets up a pre-commit hook that automatically runs `build/template/unpack_templates.sh` when `install/Citate.dotm` is modified, keeping the unpacked template files in sync.
...
- Go to View->Macros->View Macros and click "Edit" for one of the Citate macros
...
protocol is used to issue commands to Citate process from Word. These commands are received in [commandLineHandler.js](https://github.com/dchawisher/citate/blob/81591eb890b76bb98ff348e1f7d08356188ec8f0/chrome/content/zotero/xpcom/commandLineHandler.js#L102-L110)
where they are passed to integration.js.

Citate talks to Word via [js-ctypes bindings](https://github.com/dchawisher/citate-word-for-windows-integration/blob/e960ae3a3cc676f6279d61c8b222bb9a8f149da6/components/zoteroWinWordIntegration.mjs)
to a C++ OLE Automation based [library](https://github.com/dchawisher/citate-word-for-windows-integration/blob/e960ae3a3cc676f6279d61c8b222bb9a8f149da6/build/zoteroWinWordIntegration/zoteroWinWordIntegration.h).
